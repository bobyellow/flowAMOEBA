...
def getFlowNeighborsContiguity(AREAS1, AREAS2, FlowValue, Level):
    ...
    Wqueen2, Wrook2 = getNeighborsAreaContiguity(AREAS2)  # For destination areas
    
    Grid1Wrook = Wrook  # Assign Rook's contiguity to Grid1
    Grid2Wrook = Wrook2  # Assign Rook's contiguity to Grid2
    #Grid1Wrook = Wqueen  # Assign Queen's contiguity to Grid1
    #Grid2Wrook = Wqueen2  # Assign Queen's contiguity to Grid2
    ...
    print('Obtain O & D neighbors by contiguity') 
